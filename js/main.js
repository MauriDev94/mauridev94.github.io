const translations = {
  en: {
    ...
    "projects.monolith.desc": "Modular monolith (FastAPI) with Clean Architecture and DDD. JWT, OAuth2, OTP and Google SSO — deployed to production on Render.",
  ...
  es: {
    ...
    "projects.monolith.desc": "Monolito modular (FastAPI) con Clean Architecture y DDD. JWT, OAuth2, OTP y Google SSO — desplegado en producción en Render.",
    "stack.heading": "Tech Stack",
